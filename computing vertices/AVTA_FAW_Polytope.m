...
% 
% hold on;
% plot(num_vtx_vec,time_ta,'Color',[0 0 1],'DisplayName','Triangle Algorithm');
% plot(num_vtx_vec,time_aa,'--','Color',[1 0 1],'DisplayName','FastAnchorWord');
% title('perturbation variance vs running time(1000 rand proj)')
% 
% hold off;
% 
